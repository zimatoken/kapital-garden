...
export const STRINGS = {
  ...
  // ─── Цели ──────────────────────────────────
  goalsEmptyTitle: '🌱 Твой сад целей пуст',
  goalsEmptyBody:
    'Посади первую цель — и она будет расти вместе с твоими отложениями. Квартира, машина, пенсия — что угодно.',
  goalEditorTitle: '🌱 Новая цель',
